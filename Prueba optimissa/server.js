...
app.get("/policies",
    ...
    function (req, res) {
        ...
        if (arrPolicies == null) {
            ...
            respuesta = { error: false, codigo: 405, mensaje: 'No hay politicas' }
...
app.get("/policies/client",
    ...
    function (req, res) {
        ...
        if (id) {
            ...
            respuesta = { error: false, codigo: 200, mensaje: "Escribe un id" }
...
//Exportamos el modulo app para el testing
